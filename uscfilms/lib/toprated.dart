...
class TopRated extends StatefulWidget {
  @override
  final bool type;
  TopRated({Key key, @required this.type}) : super(key: key);
...
class _TopRatedState extends State<TopRated> {
  ...
  Future<String> getdata() async {
    if (type == true) {
      uri = "http://10.0.2.2:5000/movie/toprated";
    } else {
      uri = "http://10.0.2.2:5000/tv/toprated";
    }
  ...
  somefunction(int choice, String id, String actualid, String tit) async {
    ...
    if (choice == 3) {
      SocialShare.shareTwitter("Check this out!",
            ...
            child: Stack(children: [
              ...
              Positioned(
                  ...
                  child: PopupMenuButton<int>(
                    color: Colors.white,
                    onSelected: (choice) {
                      somefunction(choice, img2, id2.toString(), title2);
                    },
                    itemBuilder: (context) => [
                      PopupMenuItem(
                        value: 1,
